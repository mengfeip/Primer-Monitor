...
def create_report(args):
    ...
    # Read the summary results -- this populates the summary table and defines the corresponding regions

    summary_file = args.summary
    summary = GenericTable.from_summaryfile(summary_file, args.summary_columns)
    ...
    with open(template_file, "r") as f:
        ...
        with open(output_file, "w") as o:
            ...
            for i, line in enumerate(data):
                ...
                j = line.find('"@SUMMARY_JSON@"')
                if j >= 0:
                    line = line.replace('"@SUMMARY_JSON@"', summary.to_JSON())
...
def main():
    ...
    parser.add_argument("--summary", help="summary file for results, required")
    parser.add_argument("--summary-columns", nargs="+", help="list of info field names to include in summary table")
